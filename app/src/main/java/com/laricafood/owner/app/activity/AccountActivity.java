...
public class AccountActivity extends AppCompatActivity
{
    ...
    private static final int SWAP_ACCOUNT_REQUEST_CODE = 200;
    ...
    public boolean onOptionsItemSelected (MenuItem item)
    {
        switch (item.getItemId())
        {
            case R.id.action_add:
                ...
                break;
            case R.id.action_swap_account:
                startActivityForResult(new Intent(ctx, SwapAccountActivity.class), SWAP_ACCOUNT_REQUEST_CODE);
                break;
        }
    ...
    {
        if (requestCode == NEW_LARICA_REQUEST_CODE)
        {
        ...
        else if (requestCode == SWAP_ACCOUNT_REQUEST_CODE)
        {
            if (resultCode == RESULT_OK)
            {
                //TODO Trocar o account para ou cliente ou comerciante.
            }
        }
    }
